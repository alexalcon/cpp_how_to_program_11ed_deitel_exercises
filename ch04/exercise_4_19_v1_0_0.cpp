/**
 * File: exercise_4_19_v1_0_0.cpp
 * Author: Alex Alcón
 * GitHub: https://github.com/alexalcon 
 * -------------------------------------------------------------------------------------------------
 * Description: ✰ (Diamond-Printing Program) Write an application that prints the following diamond
 *                 shape. You may use output statements that print a single asterisk (*), a single
 *                 space or a single newline character. Maximize your use of iteration (with nested 
